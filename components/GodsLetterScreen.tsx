...
const GodLetterScreen: React.FC<GodsLetterScreenProps> = ({ onComplete }) => {
  const fullText = `Mein geliebtes Kind,
...
Du bist wertvoll – nicht wegen dem, was du leistest, sondern einfach, weil du MEIN bist. Ich habe dich mit einem Zweck geschaffen. (Psalm 139,14)
...
Du bist mein Eigentum, mein geliebtes Kind, mein Meisterwerk.
